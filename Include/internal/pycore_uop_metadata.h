...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_SWAP_PLUS__STORE_SUBSCR_LIST_INT] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    [_LOAD_FAST_PLUS__GUARD_BOTH_FLOAT] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_EXIT_FLAG,
    [_BINARY_OP_MULTIPLY_FLOAT_PLUS__BINARY_OP_ADD_FLOAT_PLUS__LOAD_FAST] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_PURE_FLAG,
    [_BINARY_OP_MULTIPLY_FLOAT_PLUS__GUARD_NOS_FLOAT_PLUS__BINARY_OP_ADD_FLOAT_PLUS__SWAP] = HAS_ARG_FLAG | HAS_EXIT_FLAG,
    [_BINARY_OP_MULTIPLY_FLOAT_PLUS__LOAD_FAST] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_PURE_FLAG,
    [_BINARY_SUBSCR_LIST_INT_PLUS__LOAD_FAST] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_DEOPT_FLAG,
    [_COPY_PLUS__BINARY_SUBSCR_LIST_INT_PLUS__LOAD_FAST_0] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_DEOPT_FLAG,
    [_GUARD_BOTH_FLOAT_PLUS__BINARY_OP_MULTIPLY_FLOAT_PLUS__STORE_FAST] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_EXIT_FLAG,
    [_GUARD_NOS_FLOAT_PLUS__BINARY_OP_ADD_FLOAT_PLUS__SWAP] = HAS_ARG_FLAG | HAS_EXIT_FLAG,
    [_GUARD_NOT_EXHAUSTED_LIST_PLUS__ITER_NEXT_LIST] = HAS_EXIT_FLAG,
    [_ITER_NEXT_RANGE_PLUS__STORE_FAST_4] = HAS_LOCAL_FLAG | HAS_ERROR_FLAG,
    [_LOAD_FAST_3_PLUS__SET_IP_PLUS__GET_ITER_PLUS__CHECK_VALIDITY] = HAS_LOCAL_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_OPERAND_FLAG,
    [_LOAD_FAST_PLUS__BINARY_OP_MULTIPLY_FLOAT_PLUS__BINARY_OP_ADD_FLOAT_PLUS__LOAD_CONST_INLINE] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_PURE_FLAG | HAS_OPERAND_FLAG,
    [_LOAD_FAST_PLUS__BINARY_OP_MULTIPLY_FLOAT_PLUS__GUARD_NOS_FLOAT_PLUS__BINARY_OP_ADD_FLOAT] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_EXIT_FLAG,
    [_LOAD_FAST_PLUS__BINARY_OP_MULTIPLY_FLOAT_PLUS__GUARD_NOS_FLOAT_PLUS__BINARY_OP_SUBTRACT_FLOAT] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_EXIT_FLAG,
    [_LOAD_FAST_PLUS__GUARD_BOTH_FLOAT_PLUS__BINARY_OP_SUBTRACT_FLOAT] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_EXIT_FLAG,
    [_LOAD_FAST_PLUS__GUARD_NOS_FLOAT_PLUS__BINARY_OP_MULTIPLY_FLOAT] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_EXIT_FLAG,
    [_LOAD_FAST_PLUS__GUARD_TOS_FLOAT_PLUS__BINARY_OP_MULTIPLY_FLOAT] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_EXIT_FLAG,
    [_LOAD_FAST_PLUS__LOAD_CONST_INLINE_BORROW] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_PURE_FLAG | HAS_OPERAND_FLAG,
    [_POP_TOP_PLUS__LOAD_FAST_2_PLUS__SET_IP_PLUS__GET_ITER_PLUS__CHECK_VALIDITY] = HAS_LOCAL_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_OPERAND_FLAG,
    [_SET_IP_PLUS__BINARY_OP_PLUS__CHECK_VALIDITY] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_OPERAND_FLAG,
    [_STORE_FAST_PLUS__LOAD_FAST_0] = HAS_ARG_FLAG | HAS_LOCAL_FLAG,
    [_STORE_FAST_PLUS__LOAD_FAST_5] = HAS_ARG_FLAG | HAS_LOCAL_FLAG,
    [_STORE_FAST_PLUS__LOAD_FAST_6] = HAS_ARG_FLAG | HAS_LOCAL_FLAG,
    [_STORE_FAST_PLUS__LOAD_FAST_7] = HAS_ARG_FLAG | HAS_LOCAL_FLAG,
    [_STORE_SUBSCR_LIST_INT_PLUS__LOAD_FAST_PLUS__LOAD_CONST_INLINE_BORROW] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_DEOPT_FLAG | HAS_OPERAND_FLAG,
    [_SWAP_PLUS__STORE_SUBSCR_LIST_INT_PLUS__JUMP_TO_TOP] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    [_UNPACK_SEQUENCE_LIST_PLUS__STORE_FAST_5_PLUS__STORE_FAST_6_PLUS__STORE_FAST_7] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_DEOPT_FLAG,
};
...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_BINARY_OP_MULTIPLY_FLOAT_PLUS__BINARY_OP_ADD_FLOAT_PLUS__LOAD_FAST] = "_BINARY_OP_MULTIPLY_FLOAT_PLUS__BINARY_OP_ADD_FLOAT_PLUS__LOAD_FAST",
    [_BINARY_OP_MULTIPLY_FLOAT_PLUS__GUARD_NOS_FLOAT_PLUS__BINARY_OP_ADD_FLOAT_PLUS__SWAP] = "_BINARY_OP_MULTIPLY_FLOAT_PLUS__GUARD_NOS_FLOAT_PLUS__BINARY_OP_ADD_FLOAT_PLUS__SWAP",
    [_BINARY_OP_MULTIPLY_FLOAT_PLUS__LOAD_FAST] = "_BINARY_OP_MULTIPLY_FLOAT_PLUS__LOAD_FAST",
    ...
    [_BINARY_SUBSCR_LIST_INT_PLUS__LOAD_FAST] = "_BINARY_SUBSCR_LIST_INT_PLUS__LOAD_FAST",
    ...
    [_COPY_PLUS__BINARY_SUBSCR_LIST_INT_PLUS__LOAD_FAST_0] = "_COPY_PLUS__BINARY_SUBSCR_LIST_INT_PLUS__LOAD_FAST_0",
    ...
    [_GUARD_BOTH_FLOAT_PLUS__BINARY_OP_MULTIPLY_FLOAT_PLUS__STORE_FAST] = "_GUARD_BOTH_FLOAT_PLUS__BINARY_OP_MULTIPLY_FLOAT_PLUS__STORE_FAST",
    ...
    [_GUARD_NOS_FLOAT_PLUS__BINARY_OP_ADD_FLOAT_PLUS__SWAP] = "_GUARD_NOS_FLOAT_PLUS__BINARY_OP_ADD_FLOAT_PLUS__SWAP",
    ...
    [_ITER_NEXT_RANGE_PLUS__STORE_FAST_4] = "_ITER_NEXT_RANGE_PLUS__STORE_FAST_4",
    ...
    [_LOAD_FAST_3_PLUS__SET_IP_PLUS__GET_ITER_PLUS__CHECK_VALIDITY] = "_LOAD_FAST_3_PLUS__SET_IP_PLUS__GET_ITER_PLUS__CHECK_VALIDITY",
    ...
    [_LOAD_FAST_PLUS__BINARY_OP_MULTIPLY_FLOAT_PLUS__BINARY_OP_ADD_FLOAT_PLUS__LOAD_CONST_INLINE] = "_LOAD_FAST_PLUS__BINARY_OP_MULTIPLY_FLOAT_PLUS__BINARY_OP_ADD_FLOAT_PLUS__LOAD_CONST_INLINE",
    [_LOAD_FAST_PLUS__BINARY_OP_MULTIPLY_FLOAT_PLUS__GUARD_NOS_FLOAT_PLUS__BINARY_OP_ADD_FLOAT] = "_LOAD_FAST_PLUS__BINARY_OP_MULTIPLY_FLOAT_PLUS__GUARD_NOS_FLOAT_PLUS__BINARY_OP_ADD_FLOAT",
    [_LOAD_FAST_PLUS__BINARY_OP_MULTIPLY_FLOAT_PLUS__GUARD_NOS_FLOAT_PLUS__BINARY_OP_SUBTRACT_FLOAT] = "_LOAD_FAST_PLUS__BINARY_OP_MULTIPLY_FLOAT_PLUS__GUARD_NOS_FLOAT_PLUS__BINARY_OP_SUBTRACT_FLOAT",
    [_LOAD_FAST_PLUS__GUARD_BOTH_FLOAT] = "_LOAD_FAST_PLUS__GUARD_BOTH_FLOAT",
    [_LOAD_FAST_PLUS__GUARD_BOTH_FLOAT_PLUS__BINARY_OP_SUBTRACT_FLOAT] = "_LOAD_FAST_PLUS__GUARD_BOTH_FLOAT_PLUS__BINARY_OP_SUBTRACT_FLOAT",
    [_LOAD_FAST_PLUS__GUARD_NOS_FLOAT_PLUS__BINARY_OP_MULTIPLY_FLOAT] = "_LOAD_FAST_PLUS__GUARD_NOS_FLOAT_PLUS__BINARY_OP_MULTIPLY_FLOAT",
    [_LOAD_FAST_PLUS__GUARD_TOS_FLOAT_PLUS__BINARY_OP_MULTIPLY_FLOAT] = "_LOAD_FAST_PLUS__GUARD_TOS_FLOAT_PLUS__BINARY_OP_MULTIPLY_FLOAT",
    [_LOAD_FAST_PLUS__LOAD_CONST_INLINE_BORROW] = "_LOAD_FAST_PLUS__LOAD_CONST_INLINE_BORROW",
    ...
    [_POP_TOP_PLUS__LOAD_FAST_2_PLUS__SET_IP_PLUS__GET_ITER_PLUS__CHECK_VALIDITY] = "_POP_TOP_PLUS__LOAD_FAST_2_PLUS__SET_IP_PLUS__GET_ITER_PLUS__CHECK_VALIDITY",
    ...
    [_SET_IP] = "_SET_IP",
    [_SET_IP_PLUS__BINARY_OP_PLUS__CHECK_VALIDITY] = "_SET_IP_PLUS__BINARY_OP_PLUS__CHECK_VALIDITY",
    ...
    [_STORE_FAST_PLUS__LOAD_FAST_0] = "_STORE_FAST_PLUS__LOAD_FAST_0",
    [_STORE_FAST_PLUS__LOAD_FAST_5] = "_STORE_FAST_PLUS__LOAD_FAST_5",
    [_STORE_FAST_PLUS__LOAD_FAST_6] = "_STORE_FAST_PLUS__LOAD_FAST_6",
    [_STORE_FAST_PLUS__LOAD_FAST_7] = "_STORE_FAST_PLUS__LOAD_FAST_7",
    ...
    [_STORE_SUBSCR_LIST_INT_PLUS__LOAD_FAST_PLUS__LOAD_CONST_INLINE_BORROW] = "_STORE_SUBSCR_LIST_INT_PLUS__LOAD_FAST_PLUS__LOAD_CONST_INLINE_BORROW",
    [_SWAP] = "_SWAP",
    [_SWAP_PLUS__STORE_SUBSCR_LIST_INT] = "_SWAP_PLUS__STORE_SUBSCR_LIST_INT",
    [_SWAP_PLUS__STORE_SUBSCR_LIST_INT_PLUS__JUMP_TO_TOP] = "_SWAP_PLUS__STORE_SUBSCR_LIST_INT_PLUS__JUMP_TO_TOP",
    ...
    [_UNPACK_SEQUENCE_LIST_PLUS__STORE_FAST_5_PLUS__STORE_FAST_6_PLUS__STORE_FAST_7] = "_UNPACK_SEQUENCE_LIST_PLUS__STORE_FAST_5_PLUS__STORE_FAST_6_PLUS__STORE_FAST_7",
