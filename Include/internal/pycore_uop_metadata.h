...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_RETURN_VALUE_PLUS__LOAD_FAST_5] = HAS_LOCAL_FLAG,
    [_RESUME_CHECK_PLUS__LOAD_CONST_INLINE] = HAS_DEOPT_FLAG | HAS_OPERAND_FLAG,
    [_UNPACK_SEQUENCE_TWO_TUPLE_PLUS__STORE_FAST_4] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_DEOPT_FLAG,
    [_SET_IP_PLUS__BINARY_OP] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_OPERAND_FLAG,
    [_BINARY_OP_PLUS__CHECK_VALIDITY] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_BINARY_OP_ADD_FLOAT_PLUS__STORE_FAST_3] = HAS_LOCAL_FLAG,
    ...
    [_BINARY_OP_ADD_INT_PLUS__LOAD_FAST_0] = HAS_LOCAL_FLAG | HAS_ERROR_FLAG | HAS_PURE_FLAG,
    [_BINARY_OP_MULTIPLY_INT_PLUS__LOAD_CONST_INLINE_BORROW] = HAS_ERROR_FLAG | HAS_PURE_FLAG | HAS_OPERAND_FLAG,
    ...
    [_GUARD_NOS_INT_PLUS__LOAD_CONST_INLINE_BORROW] = HAS_EXIT_FLAG | HAS_OPERAND_FLAG,
    ...
    [_LOAD_CONST_INLINE_BORROW_PLUS__BINARY_OP_ADD_INT] = HAS_ERROR_FLAG | HAS_PURE_FLAG | HAS_OPERAND_FLAG,
    [_LOAD_FAST_0_PLUS__GUARD_NOS_INT] = HAS_LOCAL_FLAG | HAS_EXIT_FLAG,
    [_LOAD_FAST_0_PLUS__LOAD_FAST_1] = HAS_LOCAL_FLAG | HAS_PURE_FLAG,
    [_LOAD_FAST_1_PLUS__BINARY_OP_ADD_INT] = HAS_LOCAL_FLAG | HAS_ERROR_FLAG | HAS_PURE_FLAG,
    [_LOAD_FAST_1_PLUS__GUARD_BOTH_INT] = HAS_LOCAL_FLAG | HAS_EXIT_FLAG,
    [_LOAD_FAST_3_PLUS__CHECK_FUNCTION] = HAS_LOCAL_FLAG | HAS_DEOPT_FLAG | HAS_OPERAND_FLAG,
    [_PUSH_FRAME_PLUS__RESUME_CHECK] = HAS_DEOPT_FLAG,
    [_SAVE_RETURN_OFFSET_PLUS__PUSH_FRAME] = HAS_ARG_FLAG,
    [_STORE_FAST_3_PLUS__JUMP_TO_TOP] = HAS_LOCAL_FLAG,
    [_STORE_FAST_4_PLUS__STORE_FAST_5] = HAS_LOCAL_FLAG,
    [_STORE_FAST_5_PLUS__LOAD_FAST_3] = HAS_LOCAL_FLAG,
...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_BINARY_OP_ADD_FLOAT_PLUS__STORE_FAST_3] = "_BINARY_OP_ADD_FLOAT_PLUS__STORE_FAST_3",
    [_BINARY_OP_ADD_INT] = "_BINARY_OP_ADD_INT",
    [_BINARY_OP_ADD_INT_PLUS__LOAD_CONST_INLINE_BORROW] = "_BINARY_OP_ADD_INT_PLUS__LOAD_CONST_INLINE_BORROW",
    [_BINARY_OP_ADD_INT_PLUS__LOAD_FAST_0] = "_BINARY_OP_ADD_INT_PLUS__LOAD_FAST_0",
    ...
    [_BINARY_OP_MULTIPLY_INT_PLUS__LOAD_CONST_INLINE_BORROW] = "_BINARY_OP_MULTIPLY_INT_PLUS__LOAD_CONST_INLINE_BORROW",
    [_BINARY_OP_PLUS__CHECK_VALIDITY] = "_BINARY_OP_PLUS__CHECK_VALIDITY",
    ...
    [_GUARD_NOS_INT_PLUS__LOAD_CONST_INLINE_BORROW] = "_GUARD_NOS_INT_PLUS__LOAD_CONST_INLINE_BORROW",
    ...
    [_LOAD_CONST_INLINE_BORROW_PLUS__BINARY_OP_ADD_INT] = "_LOAD_CONST_INLINE_BORROW_PLUS__BINARY_OP_ADD_INT",
    ...
    [_LOAD_FAST_0_PLUS__GUARD_NOS_INT] = "_LOAD_FAST_0_PLUS__GUARD_NOS_INT",
    [_LOAD_FAST_0_PLUS__LOAD_FAST_1] = "_LOAD_FAST_0_PLUS__LOAD_FAST_1",
    [_LOAD_FAST_1] = "_LOAD_FAST_1",
    [_LOAD_FAST_1_PLUS__BINARY_OP_ADD_INT] = "_LOAD_FAST_1_PLUS__BINARY_OP_ADD_INT",
    [_LOAD_FAST_1_PLUS__GUARD_BOTH_INT] = "_LOAD_FAST_1_PLUS__GUARD_BOTH_INT",
    [_LOAD_FAST_2] = "_LOAD_FAST_2",
    [_LOAD_FAST_3] = "_LOAD_FAST_3",
    [_LOAD_FAST_3_PLUS__CHECK_FUNCTION] = "_LOAD_FAST_3_PLUS__CHECK_FUNCTION",
    ...
    [_RESUME_CHECK_PLUS__LOAD_CONST_INLINE] = "_RESUME_CHECK_PLUS__LOAD_CONST_INLINE",
    [_RETURN_GENERATOR] = "_RETURN_GENERATOR",
    [_RETURN_VALUE] = "_RETURN_VALUE",
    [_RETURN_VALUE_PLUS__LOAD_FAST_5] = "_RETURN_VALUE_PLUS__LOAD_FAST_5",
    ...
    [_SET_IP] = "_SET_IP",
    [_SET_IP_PLUS__BINARY_OP] = "_SET_IP_PLUS__BINARY_OP",
    ...
    [_STORE_FAST_3_PLUS__JUMP_TO_TOP] = "_STORE_FAST_3_PLUS__JUMP_TO_TOP",
    [_STORE_FAST_4] = "_STORE_FAST_4",
    [_STORE_FAST_4_PLUS__STORE_FAST_5] = "_STORE_FAST_4_PLUS__STORE_FAST_5",
    [_STORE_FAST_5] = "_STORE_FAST_5",
    [_STORE_FAST_5_PLUS__LOAD_FAST_3] = "_STORE_FAST_5_PLUS__LOAD_FAST_3",
    ...
    [_UNPACK_SEQUENCE_TWO_TUPLE_PLUS__STORE_FAST_4] = "_UNPACK_SEQUENCE_TWO_TUPLE_PLUS__STORE_FAST_4",
