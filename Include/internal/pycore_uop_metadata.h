...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_LIST_APPEND_PLUS__JUMP_TO_TOP_PLUS__TIER2_RESUME_CHECK] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG,
    [_PUSH_FRAME_PLUS__DYNAMIC_EXIT_PLUS__START_EXECUTOR] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG | HAS_OPERAND_FLAG,
    [_BINARY_OP_ADD_INT_PLUS__SET_IP] = HAS_ERROR_FLAG | HAS_OPERAND_FLAG,
    ...
    [_CHECK_STACK_SPACE_OPERAND_PLUS__INIT_CALL_PY_EXACT_ARGS_2] = HAS_DEOPT_FLAG | HAS_OPERAND_FLAG,
    ...
    [_CHECK_VALIDITY_PLUS__RETURN_VALUE] = HAS_DEOPT_FLAG,
    ...
    [_INIT_CALL_PY_EXACT_ARGS_1_PLUS__SAVE_RETURN_OFFSET_PLUS__PUSH_FRAME] = HAS_ARG_FLAG,
    [_INIT_CALL_PY_EXACT_ARGS_2_PLUS__SAVE_RETURN_OFFSET] = HAS_ARG_FLAG,
    ...
    [_LOAD_ATTR_PLUS__CHECK_VALIDITY_PLUS__STORE_FAST_2_PLUS__LOAD_FAST_0] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_LOCAL_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_LOAD_FAST_0_PLUS__LOAD_FAST_1_PLUS__SET_IP_PLUS__CALL_BUILTIN_FAST_PLUS__CHECK_PERIODIC] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_EVAL_BREAK_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_OPERAND_FLAG,
    ...
    [_SAVE_RETURN_OFFSET_PLUS__PUSH_FRAME_PLUS__RESUME_CHECK] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    ...
    [_STORE_FAST_4_PLUS__STORE_FAST_5] = HAS_LOCAL_FLAG,
...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_BINARY_OP_ADD_INT_PLUS__SET_IP] = "_BINARY_OP_ADD_INT_PLUS__SET_IP",
    ...
    [_CHECK_STACK_SPACE_OPERAND_PLUS__INIT_CALL_PY_EXACT_ARGS_2] = "_CHECK_STACK_SPACE_OPERAND_PLUS__INIT_CALL_PY_EXACT_ARGS_2",
    ...
    [_CHECK_VALIDITY_PLUS__RETURN_VALUE] = "_CHECK_VALIDITY_PLUS__RETURN_VALUE",
    ...
    [_INIT_CALL_PY_EXACT_ARGS_1_PLUS__SAVE_RETURN_OFFSET_PLUS__PUSH_FRAME] = "_INIT_CALL_PY_EXACT_ARGS_1_PLUS__SAVE_RETURN_OFFSET_PLUS__PUSH_FRAME",
    [_INIT_CALL_PY_EXACT_ARGS_2] = "_INIT_CALL_PY_EXACT_ARGS_2",
    [_INIT_CALL_PY_EXACT_ARGS_2_PLUS__SAVE_RETURN_OFFSET] = "_INIT_CALL_PY_EXACT_ARGS_2_PLUS__SAVE_RETURN_OFFSET",
    ...
    [_LIST_APPEND_PLUS__JUMP_TO_TOP_PLUS__TIER2_RESUME_CHECK] = "_LIST_APPEND_PLUS__JUMP_TO_TOP_PLUS__TIER2_RESUME_CHECK",
    ...
    [_LOAD_ATTR_PLUS__CHECK_VALIDITY_PLUS__STORE_FAST_2_PLUS__LOAD_FAST_0] = "_LOAD_ATTR_PLUS__CHECK_VALIDITY_PLUS__STORE_FAST_2_PLUS__LOAD_FAST_0",
    ...
    [_LOAD_FAST_0_PLUS__LOAD_FAST_1_PLUS__SET_IP_PLUS__CALL_BUILTIN_FAST_PLUS__CHECK_PERIODIC] = "_LOAD_FAST_0_PLUS__LOAD_FAST_1_PLUS__SET_IP_PLUS__CALL_BUILTIN_FAST_PLUS__CHECK_PERIODIC",
    [_LOAD_FAST_1] = "_LOAD_FAST_1",
    [_LOAD_FAST_1_PLUS__GUARD_BOTH_INT] = "_LOAD_FAST_1_PLUS__GUARD_BOTH_INT",
    ...
    [_PUSH_FRAME_PLUS__DYNAMIC_EXIT_PLUS__START_EXECUTOR] = "_PUSH_FRAME_PLUS__DYNAMIC_EXIT_PLUS__START_EXECUTOR",
    ...
    [_SAVE_RETURN_OFFSET_PLUS__PUSH_FRAME_PLUS__RESUME_CHECK] = "_SAVE_RETURN_OFFSET_PLUS__PUSH_FRAME_PLUS__RESUME_CHECK",
    ...
    [_STORE_FAST_4_PLUS__STORE_FAST_5] = "_STORE_FAST_4_PLUS__STORE_FAST_5",
