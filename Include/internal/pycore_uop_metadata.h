...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_TO_BOOL_ALWAYS_TRUE] = HAS_DEOPT_FLAG | HAS_OPERAND_FLAG,
    ...
    [_GUARD_TYPE_VERSION] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG | HAS_OPERAND_FLAG,
    [_CHECK_MANAGED_OBJECT_HAS_VALUES] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG,
    [_LOAD_ATTR_INSTANCE_VALUE] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_OPERAND_FLAG,
    ...
    [_LOAD_ATTR_SLOT] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_OPERAND_FLAG,
    [_CHECK_ATTR_CLASS] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG | HAS_OPERAND_FLAG,
    [_LOAD_ATTR_CLASS] = HAS_ARG_FLAG | HAS_OPERAND_FLAG,
    ...
    [_LOAD_CONST_INLINE] = HAS_OPERAND_FLAG,
    [_LOAD_CONST_INLINE_BORROW] = HAS_OPERAND_FLAG,
    [_LOAD_CONST_INLINE_WITH_NULL] = HAS_OPERAND_FLAG,
    [_LOAD_CONST_INLINE_BORROW_WITH_NULL] = HAS_OPERAND_FLAG,
