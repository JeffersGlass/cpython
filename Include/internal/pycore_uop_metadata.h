...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_TO_BOOL_ALWAYS_TRUE] = HAS_DEOPT_FLAG | HAS_EXIT_FLAG | HAS_OPERAND_FLAG,
    ...
    [_GUARD_TYPE_VERSION] = HAS_DEOPT_FLAG | HAS_EXIT_FLAG | HAS_PASSTHROUGH_FLAG | HAS_OPERAND_FLAG,
    ...
    [_CHECK_ATTR_MODULE] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG | HAS_OPERAND_FLAG,
    ...
    [_LOAD_ATTR_WITH_HINT] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG | HAS_OPERAND_FLAG,
    ...
    [_CHECK_ATTR_CLASS] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG | HAS_OPERAND_FLAG,
    ...
    [_STORE_ATTR_INSTANCE_VALUE] = HAS_ESCAPES_FLAG | HAS_OPERAND_FLAG,
    [_STORE_ATTR_SLOT] = HAS_ESCAPES_FLAG | HAS_OPERAND_FLAG,
    ...
    [_GUARD_KEYS_VERSION] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG | HAS_OPERAND_FLAG,
    [_LOAD_ATTR_METHOD_WITH_VALUES] = HAS_ARG_FLAG | HAS_ESCAPES_FLAG | HAS_OPERAND_FLAG,
    [_LOAD_ATTR_METHOD_NO_DICT] = HAS_ARG_FLAG | HAS_ESCAPES_FLAG | HAS_OPERAND_FLAG,
    ...
    [_LOAD_ATTR_METHOD_LAZY_DICT] = HAS_ARG_FLAG | HAS_ESCAPES_FLAG | HAS_OPERAND_FLAG,
    ...
    [_CHECK_FUNCTION_EXACT_ARGS] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG | HAS_OPERAND_FLAG,
    ...
    [_CHECK_GLOBALS] = HAS_DEOPT_FLAG | HAS_OPERAND_FLAG,
    [_CHECK_BUILTINS] = HAS_DEOPT_FLAG | HAS_OPERAND_FLAG,
    [_INTERNAL_INCREMENT_OPT_COUNTER] = 0,
    [_COLD_EXIT] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_START_EXECUTOR] = HAS_OPERAND_FLAG,
