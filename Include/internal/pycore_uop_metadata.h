...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_COPY_PLUS__TO_BOOL_BOOL] = HAS_ARG_FLAG | HAS_EXIT_FLAG,
    [_LOAD_FAST_0_PLUS__GUARD_TYPE_VERSION] = HAS_LOCAL_FLAG | HAS_EXIT_FLAG | HAS_OPERAND_FLAG,
    [_GUARD_NOS_INT_PLUS__BINARY_OP_ADD_INT] = HAS_EXIT_FLAG | HAS_ERROR_FLAG,
};
...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_COPY_PLUS__TO_BOOL_BOOL] = "_COPY_PLUS__TO_BOOL_BOOL",
    ...
    [_GUARD_NOS_INT_PLUS__BINARY_OP_ADD_INT] = "_GUARD_NOS_INT_PLUS__BINARY_OP_ADD_INT",
