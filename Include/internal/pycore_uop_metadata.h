...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_COPY_PLUS__TO_BOOL_BOOL] = HAS_PURE_FLAG,
    [_COPY_PLUS__LOAD_FAST_0_PLUS__TO_BOOL_BOOL] = HAS_PURE_FLAG,
};
...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_COPY_PLUS__LOAD_FAST_0_PLUS__TO_BOOL_BOOL] = "_COPY_PLUS__LOAD_FAST_0_PLUS__TO_BOOL_BOOL",
